...
public class AgendaByDayAdapter extends BaseAdapter 
    ...
    public AgendaByDayAdapter(Context context) {
        ...
        mShowLunar = prefs.getBoolean(CalendarPreferenceActivity.KEY_SHOW_LUNAR, CalendarPreferenceActivity.DEFAULT_VALUE_OF_SHOW_LUNAR);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (row.mType == TYPE_DAY) {
            ...
            if (row.mData == mTodayJulianDay) {
                ...
                if (mShowLunar)
                {
                    dateViewText += " " + Utils.lunarDate(mContext, date);
                }
            } else {
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (key.equals(CalendarPreferenceActivity.KEY_SHOW_LUNAR)) {
            ...
            if(mShowLunar != newSetting) {
                ...
                Log.d("AgendaByDayAdapter e2437c", "  ShowLunar setting changed!!!");
            }
        }
    }
}
