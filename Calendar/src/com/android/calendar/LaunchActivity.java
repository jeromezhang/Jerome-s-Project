...
*/
	 ...
	 * 
	 */
	public void initDefaultMycalendar() {
...
//            values.put(Calendars._ID, 0);
            values.put(Calendars._SYNC_ACCOUNT, "Local Calendar");
            values.put(Calendars._SYNC_ACCOUNT_TYPE, "Local");
            values.put(Calendars._SYNC_ID, "0");
            values.put(Calendars._SYNC_VERSION, "1.0");
            values.put(Calendars._SYNC_TIME, "UTC");
//            values.put(Calendars._SYNC_LOCAL_ID, 0);
            values.put("_sync_local_id", 0);
            values.put(Calendars._SYNC_DIRTY, 0);
            values.put(Calendars._SYNC_MARK, 0);
            values.put(Calendars.URL, "LOCAL://0.0");
            values.put(Calendars.NAME, "My Calendar@Local");
            values.put(Calendars.DISPLAY_NAME, getString(R.string.local_account));
            values.put(Calendars.HIDDEN, 0);
            values.put(Calendars.COLOR, -14069085);
            ...
            values.put(Calendars.LOCATION, "Location");
            ...
            Log.v("Calendar","create default calendar finished!");
        }
