...
public class MenuHelper {
    ...
    private static final int MENU_GROUP_DATE = 9;//fwr687
    ...
    public static final int MENU_GOTO_DATE = 12;//fwr687
    ...
    public static boolean onCreateOptionsMenu(Menu menu) {
      ...
      //fwr687
        item = menu.add(MENU_GROUP_DATE, MENU_GOTO_DATE, 0, R.string.menu_go_date);
        item.setIcon(android.R.drawable.ic_menu_day);
    ...
    public static boolean onOptionsItemSelected(Activity activity, MenuItem item, Navigator nav) {
        ...
        case MENU_GOTO_DATE:   
        	Intent intent = new Intent(Intent.ACTION_VIEW);
            intent.setClass(activity, GoToDateActivity.class);
            activity.startActivity(intent);
        	return true;
        }
        return false;
