...
public class CalendarPreferenceActivity extends PreferenceActivity implements OnSharedPreferenceChangeListener {
    ...
    //// e2437c
    static final String KEY_SHOW_LUNAR = "preferences_show_lunar";
    static final boolean DEFAULT_VALUE_OF_SHOW_LUNAR = true;

    static final String KEY_SHOW_WEEK = "preferences_show_week";
    static final boolean DEFAULT_VALUE_OF_SHOW_WEEK = false;
