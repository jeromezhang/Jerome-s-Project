...
/*            if (allDay) { // UTC            	//do not need to convert,it will cause error! qinghu liu/a21654 
                Time time = new Time();
...
/*            else if (cursorSize == 0) {
				...
				if (null != goToTime) {
					...
					if (DEBUGLOG)
						Log.e(TAG, "Setting listview to " + "findDayPositionNearestTime: "
								+ (newPosition + OFF_BY_ONE_BUG));
				}
				else
					mAgendaListView.setSelection(0);
